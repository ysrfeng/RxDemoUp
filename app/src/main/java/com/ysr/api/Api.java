...
/**
 * Created by yangshirong on 2017/2/26 13:44.
...
public class Api {
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(BaseApplication.getAppContext()) ? CACHE_CONTROL_CACHE : CACHE_CONTROL_CACHE;
    }

    /**
     * @param hostType NETEASE_NEWS_VIDEO：1登录  2接收数据  3发送数据
     */
